...
CREATE TABLE $SCHEMA_NAME$.recommendation (
  ...
  PRIMARY KEY (product_id,DTYPE, position, linked_product_id)
);
...
SELECT product_id, linked_product_id, code as type, link_id as position, 'SystemRecommendation' as DTYPE, null as score, null as relative_score, NOW() as created_at
