...
CREATE TABLE $SCHEMA_NAME$.recommendation (
  ...
  PRIMARY KEY (product_id,type,position,linked_product_id)
);



INSERT $SCHEMA_NAME$.recommendation
SELECT product_id, linked_product_id, 'cross_sell' as type, position, 'SystemRecommendation' as DTYPE, null as score,
null as relative_score
from $BASE_SCHEMA$.recommender_product_link
